  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <div style={calendarHeaderStyle}>
        ...
        >
          <ChevronLeft className="h-8 w-8 text-black-600" />
        </button>
        <h2 style={monthStyle}>
        ...
        <button
          ...
          className="p-3 hover:bg-gray-100 rounded-full transition-colors"
        >
          <ChevronRight className="h-8 w-8 text-black-600" />
        </button>
      </div>
            ...
            >
              ...
              <div className="flex-1 space-y-2 ml-2">
                {communications.map((comm, idx) => (
                  <div
                    key={idx}
                    className="px-3 py-2 text-sm bg-blue-50 text-red-600 rounded-lg"
                    style={{
                      margin: "4px 0",
                      cursor: "pointer",
                      transition: "all 0.2s",
