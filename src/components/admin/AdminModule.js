      ...
      {activeTab === "companies" && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            {" "}
            <h2 className="text-xl font-bold text-black-600">Companies</h2>{" "}
            <button
              onClick={handleAddCompany}
              className="flex items-center px-4 py-2 bg-black-600 text-black rounded-lg hover:bg-black-700 border-2 border-black"
            >
              {" "}
          ...
          <div style={modalStyle}>
            ...
            >
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-black-600 text-black border rounded"
                >
